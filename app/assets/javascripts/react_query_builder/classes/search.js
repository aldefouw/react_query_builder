function Search() {
	...
	Search.prototype.qb_remove_fields = function(button) {
		return $(button).closest('.fields').remove();
	};

	Search.prototype.qb_add_fields = function(button, type, content) {
		var new_id, regexp;
	...
	Search.prototype.qb_nest_fields = function(button, type) {
