...
RSpec.describe ReactQueryBuilder::QueryBuilderController, type: :controller do
	...
	describe "create" do
		...
		it 'should save Field Mappings to the QB Field Mapping table if they are present' do
			expect(ReactQueryBuilder::QbFieldMapping.find_by(model: "QbPerson").labels).to eq({"active"=>"Active", "first_name"=>"First Name", "id"=>"Id", "last_name"=>"Last Name", "middle_name"=>"Middle Name", "trained"=>"Trained"})
